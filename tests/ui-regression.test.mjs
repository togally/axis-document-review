...
const ossSourcePriority = browserSource.indexOf("source.type === 'aliyun-oss'");
assert.ok(ossSourcePriority >= 0, 'healthy OSS should remain the default cross-project source');
assert.doesNotMatch(browserSource, /CATALOG_AUTO_REFRESH_MS|setInterval\(autoRefreshCatalog|visibilitychange[^]*autoRefreshCatalog/);
